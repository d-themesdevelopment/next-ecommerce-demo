          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="flex items-center relative banner h-[270px] overflow-hidden rounded-2xl">
              ...
              <div className="left-5 lg:left-16 absolute details text-white">
                <h3 className="text-4xl font-bold mb-7">Promotions</h3>
                <button className="bg-grey-100 px-5 py-3 text-sm">
                  READ MORE
                </button>
              </div>
            </div>
...
export default BannersTwoSection;
